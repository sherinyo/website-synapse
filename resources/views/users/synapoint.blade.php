  ...
  <section class="py-5">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8">
          ...
          <!-- Tombol Input Point -->
        <div class="mt-4">
            <button type="button" class="btn px-4 py-2 rounded-pill fw-semibold"
                    style="background-color: #081F5C; color: #F2F0DE;"
                    data-bs-toggle="modal" data-bs-target="#inputPointModal">
                Input Point
            </button>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="type" class="form-label">Tipe Kegiatan</label>
                <input type="text" class="form-control" id="type" name="type" required>
            </div>
            <div class="mb-3">
                <label for="bukti" class="form-label">Upload Bukti (PDF/JPG)</label>
                <input type="file" class="form-control" id="bukti" name="bukti" accept=".pdf, .jpg, .jpeg, .png" required>
            </div>
            </div>
