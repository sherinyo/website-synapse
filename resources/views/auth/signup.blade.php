        ...
        <div style="background-color: #ffffff; border-radius: 20px; padding: 40px; box-shadow: 0 0 20px rgba(0,0,0,0.1);">
          ...
          <form method="POST" action="{{ route('signup') }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="name" id="name" class="form-control px-3 py-2" required>
            </div>

            <!-- Email -->
            <div class="mb-3">
              <label for="email" class="form-label" style="color: #081F5C;">Email</label>
              <input type="email" name="email" id="email" class="form-control px-3 py-2" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="password" name="password_confirmation" id="password_confirmation" class="form-control px-3 py-2" required>
            </div>
          ...
          <div class="text-center mt-4">
            <p style="color: #3a3a3a;">Sudah punya akun? <a href="{{ route('login') }}" style="color: #2E3192; font-weight: 600;">Login di sini</a></p>
          </div>
